...
HD_PWD='F:/projects/verilog/fpga_prototyping_codes/2.9.1Gate_level_greater_than_circuit/2.9.1Gate_level_greater_than_circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log greater_than_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source greater_than_4bit.tcl
