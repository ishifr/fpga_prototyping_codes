...
HD_PWD='F:/projects/verilog/fpga_prototyping_codes/2.9.1Gate_level_greater_than_circuit/2.9.1Gate_level_greater_than_circuit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log greater_than_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source greater_than_4bit.tcl -notrace
