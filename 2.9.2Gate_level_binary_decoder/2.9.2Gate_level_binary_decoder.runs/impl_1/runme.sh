...
HD_PWD='F:/projects/verilog/fpga_prototyping_codes/2.9.2Gate_level_binary_decoder/2.9.2Gate_level_binary_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_decoder_4x16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binary_decoder_4x16.tcl -notrace
